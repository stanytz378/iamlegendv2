 ...
 *                                                                           *
 *    Description: Main message handler for iamlegendv2 WhatsApp Bot        *
 *                                                                           *
 ***************************************************************************/
...
async function handleMessages(sock, messageUpdate) {
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '*Join our Channel:*\n[https://whatsapp.com/channel/0029Vb7fzu4EwEjmsD4Tzs1p](https://whatsapp.com/channel/0029Vb7fzu4EwEjmsD4Tzs1p)'
                }, { quoted: message });
                return;
            }
